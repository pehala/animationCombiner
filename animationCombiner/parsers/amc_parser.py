"""
Courtesy of https://github.com/CalciferZh/AMCParser/blob/master/amc_parser.py
"""
# pylint: skip-file
import numpy as np

from animationCombiner.utils.transform import euler2mat
...
def parse_amc2(file, skeleton):
    frame = parse_amc(file)[0]
    for bone, motion in frame.items():
        skeleton[bone].set_motion(motion)
    return skeleton
